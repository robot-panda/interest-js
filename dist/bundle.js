...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios_lib_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios/lib/axios */ \"./node_modules/axios/lib/axios.js\");\n/* harmony import */ var axios_lib_axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios_lib_axios__WEBPACK_IMPORTED_MODULE_0__);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((config) => {\n  let app = config.app_options.development\n  let path = `${app.app_protocol}${app.interestjs_base_path}${app.interestjs_customer_path}`\n\n  return {\n    get_customer: (customerId) => {\n      return axios_lib_axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${path}/list?customer_id=${customerId}`)\n    },\n    add_customer: (customer) => {\n      return axios_lib_axios__WEBPACK_IMPORTED_MODULE_0___default()({\n        method: 'post',\n        url: `${path}/add`,\n        data: {\n          account_id: config.user_options.account_id,\n          customer_id: customer.customer_id,\n          customer_email: customer.customer_email,\n          customer_name: customer.customer_name\n        },\n        headers: {\n          'Content-Type': 'application/vnd.api+json',\n          'Accept': 'application/vnd.api+json'\n        }\n      })\n    },\n    update: (customerId, customer) => {\n      return axios_lib_axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(`${path}/update`, {\n        id: customerId,\n        metadata: customer.metadata\n      })\n    },\n    remove: (customerId) => {\n      return axios_lib_axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`${path}/remove?id=${customerId}`)\n    }\n  }\n});\n\n\n//# sourceURL=webpack://Interest/./src/models/facades/customer.js?");
